        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex md:text-xl items-center space-x-6">
            {!user ? (
              ...
              <>
                <div className="md:text-xl text-white font-mono  transition-transform hover:scale-105">
                  {user.name}
                </div>
                ...
                >
                  <button
                    onClick={logOut}
                    className="bg-amber-700 p-1 rounded-sm py-1.5 md:w-25 text-white cursor-pointer "
                  >
                    Logout
                  </button>
                </Link>
